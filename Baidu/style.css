...
@author         QIUZAIYOU
@description    `去广告，样式更改。`
@version        2021.0727.1740
@license        NO-REDISTRIBUTION
@preprocessor   uso
@advanced dropdown trebleList "搜索结果三列显示" {
    trebleist_ON "开" <<<EOT 
	#rs,
	#foot,
	[tpl="recommend_list"]{
	...
	div#content_left > div[class].hit-toptip.new-pmd,
	...
	div#content_left > div[class].hit-toptip.new-pmd .c-gap-bottom-large{
		margin: 0!important;
	}
	div#content_left > div[class] .c-span9,
	div#content_left > div[class] canvas {
		width: 100%!important;
	}
	div#content_left > div[class].new-pmd .c-gap-top-large,
	.new-pmd .c-row,
	.c-border,
	div#content_left > div[class].new-pmd .c-tabs.c-sub-tabs .c-tabs-content {
		width: 100%!important;
		display: flex!important;
		background: transparent!important;
	}
	div#content_left > div[class].new-pmd .c-abstract {
		margin-top: 10px!important;
	}
	div#content_left > div[class] .info-row_37tWa .info-col_2viHg {
		width: inherit!important;
	}
	div#content_left > div[class].c-container table {
		display: flex!important;
		flex-direction: column!important;
	}
	div#content_left > div[class] .re-box_2CJ9w {
		box-shadow: none!important
	}
	div#content_left > div[class].new-pmd.c-container .c-container {
		overflow: auto;
		margin: 0!important;
	}
	div#content_left > div[class] .c-border .c-span-last {
		width: 100%!important;
		margin-top: 10px!important;
	}
	div#content_left > div[class] .op-short-video-pc,
	div#content_left > div[class].new-pmd .c-tabs.c-sub-tabs .c-tabs-content .c-row {
		overflow: auto!important;
		padding-bottom: 5px!important;
	}
	div#content_left > div[class] .op-short-video-pc .c-span3 {
		width: calc((100% - 60px) / 2)!important
	}
	div#content_left > div[class].new-pmd .op-short-video-pc .c-img img {
		width: initial!important;
	}
	.op_weather4_twoicon_container_div{
		overflow-y: hidden!important;
		overflow-x: scroll!important;
	}
	div#content_left > div[class][mu*="天气"] .c-row,
	div#content_left > div[class] .wenda-abstract-wrap-new,
	div#content_left > div[class][tpl="site"]>.c-border,
	div#content_left > div[class][mu*="ip138"]>.c-border{
		flex-direction: column!important;
	}
	.op_site_box_tools table td{
		padding: 3px!important;
		text-align: center!important;
	}
	div#content_left > div[class][tpl="site"]>.c-border>.op_site_domain{
		margin-bottom: 7px!important;
	}
	div#content_left > div[class][tpl="site"]>.c-border>.op_site_domain>.op_site_domain_right,
	.op-ip-detail table{
		height: fit-content!important;
    	margin: 0!important;
	}
	div#content_left > div[class][tpl="site"]>.c-border>.op_site_domain>.op_site_domain_right>p:not([class]){
		display: flex!important;
		flex-flow: column nowrap!important;
	}
	div#content_left > div[class][mu*="ip138"]>.c-row.c-gap-top{
		display: flex!important;
		align-items: center!important;
	}
	div#content_left > div[class][tpl="site"]>.c-border>.op_site_domain>.op_site_domain_right>p:not([class])>a,
	div#content_left > div[class][mu*="ip138"]>.c-border>.c-row.c-gap-top>.c-span-last{
		margin: 0!important;
	}
	div#content_left > div[class][tpl="site"]>.c-border>.op_site_main{
		margin-top: 0!important;
		padding: 0!important;
	}
	div#content_left > div[class][tpl="site"]>.c-border>.op_site_main>.op_site_gap_top{
	...
	EOT;
	trebleList_OFF "关" <<<EOT /*[[trebleList]]*\/ EOT;
}
==/UserStyle== */
...
@-moz-document url-prefix("http://example.com") {
	 ...
	 * © UserStyles.world项目地址：https://userstyles.world/style/243/simple-baidu
	===*/
}
...
url-prefix("http://www.baidu.com") {
    ...
    div#content_left>div:not([class]) {
        display: none!important;
    }
...
url-prefix("https://www.baidu.com/baidu?") {
    ...
    div#content_left>div[class].sp-separator {
        border-color: #dedede!important;
    }
    #page .pc,
    #page .n {
